...
// Morning stops trend YELLOWER as the sun rises; evening stops trend
...
static const ColorStop STOPS_MORNING[] = {
    ...
    {  25.0f, RGB(0xFA,0xDB,0x95), RGB(0x9A,0x48,0x28) }, // late morning, warm cream
    {  45.0f, RGB(0xF8,0xDE,0xB0), RGB(0x8C,0x3F,0x1F) }, // bright midday
};
static const ColorStop STOPS_EVENING[] = {
    {  45.0f, RGB(0xF8,0xDE,0xB0), RGB(0x8C,0x3F,0x1F) }, // bright midday
    {  25.0f, RGB(0xFA,0xD0,0xA8), RGB(0x9A,0x48,0x28) }, // early afternoon, peach-tinted
